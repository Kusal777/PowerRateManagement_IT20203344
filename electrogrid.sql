...
--
-- Host: 127.0.0.1
-- Generation Time: May 11, 2022 at 09:18 AM
...
INSERT INTO `payment_form` (`payment_id`, `customer_name`, `bill_amount`, `card_no`, `expire_date`, `cv_code`) VALUES
(2, 'nuha', '200.00', 123123, '2022-02-03', 55),
(3, 'Sadeesha Jayawardhana', '2000.00', 14231111, '2024-10-21', 142);
...
(6, '0-30', '5.00', '10.00', '2022-04-14'),
(7, '31-60', '8.00', '16.00', '2022-04-15'),
(8, '61-90', '12.00', '24.00', '2022-04-16'),
(18, '91-120', '17.00', '34.00', '2022-04-17');
